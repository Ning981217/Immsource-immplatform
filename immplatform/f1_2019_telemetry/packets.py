...
# Embedded file name: f1_2019_telemetry\packets.py
...
HeaderFieldsToPacketType = {(2019, 1, 0): PacketMotionData_V1, 
...
if __name__ == '__main__':
    if not ctypes.sizeof(PacketMotionData_V1) == 1343:
        raise AssertionError
    if not ctypes.sizeof(PacketSessionData_V1) == 149:
        raise AssertionError
    if not ctypes.sizeof(PacketLapData_V1) == 843:
        raise AssertionError
    if not ctypes.sizeof(PacketEventData_V1) == 32:
        raise AssertionError
    if not ctypes.sizeof(PacketParticipantsData_V1) == 1104:
        raise AssertionError
    if not ctypes.sizeof(PacketCarSetupData_V1) == 843:
        raise AssertionError
    if not ctypes.sizeof(PacketCarTelemetryData_V1) == 1347:
        raise AssertionError
    if not ctypes.sizeof(PacketCarStatusData_V1) == 1143:
        raise AssertionError
